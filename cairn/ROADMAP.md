...
2. ~~体检 P2~~ **已全部收口**(2026-09-11):代码卫生 0.7.23、模型边界声明 0.7.24、AGC 建立动态 0.7.25、传播信道 0.7.30、音计划 0.7.31——见 `docs/backlog_zh.md` B23–B25、B29、B30。已判为不做并记明理由:`tx_iq` 多音合并(体检的热点判断被实测推翻)、`tutorial.html` 改 CI 产物、mypy。**仍未建模且写在 README 里的**:OFDMA 的 RU 划分、打孔计划的专属导频集、时变多普勒。
