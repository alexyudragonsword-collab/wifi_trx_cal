        ...
        Section(
            ...
            body=(
                T("<code>python app/main.py</code>,两个页签:"
                  "<b>Analyses</b>(全量校准、漂移跟踪、阻塞退敏、杂散规划,"
                  "参数表单由声明式 spec 生成,结果 2×2 仪表盘)与 "
                  "<b>Cal-state inspector</b>(打开 JSON,渲染检查器结论/"
                  "逐步表/溯源——页面自身不做任何判断,measured by test)。",
                  "<code>python app/main.py</code>, two tabs: "
                  "<b>Analyses</b> (full calibration, drift tracking, "
                  "blocker desense, spur planning; forms generated from "
                  "declarative specs, results in a 2×2 dashboard) and "
